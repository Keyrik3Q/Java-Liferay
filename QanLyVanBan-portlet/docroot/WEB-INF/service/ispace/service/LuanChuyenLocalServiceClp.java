 ...
 * @generated
 */
public class LuanChuyenLocalServiceClp implements LuanChuyenLocalService {
	public LuanChuyenLocalServiceClp(
	...
	public ispace.model.LuanChuyen addLuanChuyen(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(luanChuyen) });
		}
		catch (Throwable t) {
		...
		return (ispace.model.LuanChuyen)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<ispace.model.LuanChuyen> getLuanChuyens(int start,
		...
		return (java.util.List<ispace.model.LuanChuyen>)ClpSerializer.translateOutput(returnObj);
	}
