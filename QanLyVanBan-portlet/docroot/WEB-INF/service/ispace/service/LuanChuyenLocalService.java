...
/**
 * Provides the local service interface for LuanChuyen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hungt
 * @see LuanChuyenLocalServiceUtil
...
public interface LuanChuyenLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LuanChuyenLocalServiceUtil} to access the luan chuyen local service. Add custom service methods to {@link ispace.service.impl.LuanChuyenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
