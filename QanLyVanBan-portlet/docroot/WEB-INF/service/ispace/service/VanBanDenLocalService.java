...
/**
 * Provides the local service interface for VanBanDen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hungt
 * @see VanBanDenLocalServiceUtil
...
public interface VanBanDenLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VanBanDenLocalServiceUtil} to access the van ban den local service. Add custom service methods to {@link ispace.service.impl.VanBanDenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
