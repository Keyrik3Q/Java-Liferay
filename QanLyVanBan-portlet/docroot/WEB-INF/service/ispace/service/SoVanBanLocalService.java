...
/**
 * Provides the local service interface for SoVanBan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hungt
 * @see SoVanBanLocalServiceUtil
...
public interface SoVanBanLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SoVanBanLocalServiceUtil} to access the so van ban local service. Add custom service methods to {@link ispace.service.impl.SoVanBanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
