...
/**
 * Provides the local service interface for NguoiDung. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hungt
 * @see NguoiDungLocalServiceUtil
...
public interface NguoiDungLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NguoiDungLocalServiceUtil} to access the nguoi dung local service. Add custom service methods to {@link ispace.service.impl.NguoiDungLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
