...
/**
 * The persistence utility for the luan chuyen service. This utility wraps {@link LuanChuyenPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LuanChuyenUtil {
	 ...
	 */
	public static void clearCache(LuanChuyen luanChuyen) {
		getPersistence().clearCache(luanChuyen);
	}
	 ...
	 */
	public static List<LuanChuyen> findWithDynamicQuery(
	 ...
	 */
	public static LuanChuyen update(LuanChuyen luanChuyen)
		throws SystemException {
		return getPersistence().update(luanChuyen);
	}
	...
	public static LuanChuyen update(LuanChuyen luanChuyen,
		...
		return getPersistence().update(luanChuyen, serviceContext);
	}
	...
	*/
	public static void cacheResult(ispace.model.LuanChuyen luanChuyen) {
		getPersistence().cacheResult(luanChuyen);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<ispace.model.LuanChuyen> luanChuyens) {
		getPersistence().cacheResult(luanChuyens);
	}
	...
	*/
	public static ispace.model.LuanChuyen create(long Id) {
	...
	*/
	public static ispace.model.LuanChuyen remove(long Id)
		throws com.liferay.portal.kernel.exception.SystemException,
			ispace.NoSuchLuanChuyenException {
		return getPersistence().remove(Id);
	}

	public static ispace.model.LuanChuyen updateImpl(
		ispace.model.LuanChuyen luanChuyen)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(luanChuyen);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ispace.model.LuanChuyen findByPrimaryKey(long Id)
		throws com.liferay.portal.kernel.exception.SystemException,
			ispace.NoSuchLuanChuyenException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ispace.model.LuanChuyen fetchByPrimaryKey(long Id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ispace.model.LuanChuyen> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ispace.model.LuanChuyen> findAll(int start,
	...
	*/
	...
	public static LuanChuyenPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LuanChuyenPersistence)PortletBeanLocatorUtil.locate(ispace.service.ClpSerializer.getServletContextName(),
					LuanChuyenPersistence.class.getName());

			ReferenceRegistry.registerReference(LuanChuyenUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LuanChuyenPersistence persistence) {
	}

	private static LuanChuyenPersistence _persistence;
}