...
/**
 * The persistence utility for the van ban den service. This utility wraps {@link VanBanDenPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class VanBanDenUtil {
	 ...
	 */
	public static void clearCache(VanBanDen vanBanDen) {
		getPersistence().clearCache(vanBanDen);
	}
	 ...
	 */
	public static List<VanBanDen> findWithDynamicQuery(
	 ...
	 */
	public static VanBanDen update(VanBanDen vanBanDen)
		throws SystemException {
		return getPersistence().update(vanBanDen);
	}
	...
	public static VanBanDen update(VanBanDen vanBanDen,
		...
		return getPersistence().update(vanBanDen, serviceContext);
	}
	...
	*/
	public static void cacheResult(ispace.model.VanBanDen vanBanDen) {
		getPersistence().cacheResult(vanBanDen);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<ispace.model.VanBanDen> vanBanDens) {
		getPersistence().cacheResult(vanBanDens);
	}
	...
	*/
	public static ispace.model.VanBanDen create(long Id) {
	...
	*/
	public static ispace.model.VanBanDen remove(long Id)
		throws com.liferay.portal.kernel.exception.SystemException,
			ispace.NoSuchVanBanDenException {
		return getPersistence().remove(Id);
	}

	public static ispace.model.VanBanDen updateImpl(
		ispace.model.VanBanDen vanBanDen)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(vanBanDen);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ispace.model.VanBanDen findByPrimaryKey(long Id)
		throws com.liferay.portal.kernel.exception.SystemException,
			ispace.NoSuchVanBanDenException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ispace.model.VanBanDen fetchByPrimaryKey(long Id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ispace.model.VanBanDen> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ispace.model.VanBanDen> findAll(int start,
	...
	*/
	...
	public static VanBanDenPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (VanBanDenPersistence)PortletBeanLocatorUtil.locate(ispace.service.ClpSerializer.getServletContextName(),
					VanBanDenPersistence.class.getName());

			ReferenceRegistry.registerReference(VanBanDenUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(VanBanDenPersistence persistence) {
	}

	private static VanBanDenPersistence _persistence;
}