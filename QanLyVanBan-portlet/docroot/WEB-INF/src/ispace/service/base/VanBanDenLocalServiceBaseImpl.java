...
import ispace.service.VanBanDenLocalService;
...
/**
 * Provides the base implementation for the van ban den local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ispace.service.impl.VanBanDenLocalServiceImpl}.
 * </p>
 *
 * @author hungt
 ...
 * @generated
 */
public abstract class VanBanDenLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VanBanDenLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link ispace.service.VanBanDenLocalServiceUtil} to access the van ban den local service.
	 */
	...
	@Override
	public VanBanDen addVanBanDen(VanBanDen vanBanDen)
		throws SystemException {
		vanBanDen.setNew(true);

		return vanBanDenPersistence.update(vanBanDen);
	}
	 ...
	 */
	@Override
	public VanBanDen createVanBanDen(long Id) {
		return vanBanDenPersistence.create(Id);
	}
	...
	@Override
	public VanBanDen deleteVanBanDen(long Id)
		throws PortalException, SystemException {
		return vanBanDenPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VanBanDen deleteVanBanDen(VanBanDen vanBanDen)
		throws SystemException {
		return vanBanDenPersistence.remove(vanBanDen);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VanBanDen.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return vanBanDenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vanBanDenPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vanBanDenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VanBanDen fetchVanBanDen(long Id) throws SystemException {
		return vanBanDenPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public VanBanDen getVanBanDen(long Id)
		throws PortalException, SystemException {
		return vanBanDenPersistence.findByPrimaryKey(Id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vanBanDenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VanBanDen> getVanBanDens(int start, int end)
		throws SystemException {
		return vanBanDenPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVanBanDensCount() throws SystemException {
		return vanBanDenPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VanBanDen updateVanBanDen(VanBanDen vanBanDen)
		throws SystemException {
		return vanBanDenPersistence.update(vanBanDen);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("ispace.model.VanBanDen",
			vanBanDenLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"ispace.model.VanBanDen");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vanBanDenPersistence.getDataSource();
	...
	private VanBanDenLocalServiceClpInvoker _clpInvoker = new VanBanDenLocalServiceClpInvoker();
}