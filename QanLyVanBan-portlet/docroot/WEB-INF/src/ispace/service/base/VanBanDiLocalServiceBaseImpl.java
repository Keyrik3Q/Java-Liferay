...
import ispace.service.VanBanDiLocalService;
...
/**
 * Provides the base implementation for the van ban di local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ispace.service.impl.VanBanDiLocalServiceImpl}.
 * </p>
 *
 * @author hungt
 ...
 * @generated
 */
public abstract class VanBanDiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VanBanDiLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link ispace.service.VanBanDiLocalServiceUtil} to access the van ban di local service.
	 */
	...
	@Override
	public VanBanDi addVanBanDi(VanBanDi vanBanDi) throws SystemException {
		vanBanDi.setNew(true);

		return vanBanDiPersistence.update(vanBanDi);
	}
	 ...
	 */
	@Override
	public VanBanDi createVanBanDi(long Id) {
		return vanBanDiPersistence.create(Id);
	}
	...
	@Override
	public VanBanDi deleteVanBanDi(long Id)
		throws PortalException, SystemException {
		return vanBanDiPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VanBanDi deleteVanBanDi(VanBanDi vanBanDi) throws SystemException {
		return vanBanDiPersistence.remove(vanBanDi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VanBanDi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vanBanDiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vanBanDiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return vanBanDiPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vanBanDiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VanBanDi fetchVanBanDi(long Id) throws SystemException {
		return vanBanDiPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public VanBanDi getVanBanDi(long Id)
		throws PortalException, SystemException {
		return vanBanDiPersistence.findByPrimaryKey(Id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vanBanDiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VanBanDi> getVanBanDis(int start, int end)
		throws SystemException {
		return vanBanDiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVanBanDisCount() throws SystemException {
		return vanBanDiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VanBanDi updateVanBanDi(VanBanDi vanBanDi) throws SystemException {
		return vanBanDiPersistence.update(vanBanDi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("ispace.model.VanBanDi",
			vanBanDiLocalService);
	}
	...
	private VanBanDiLocalServiceClpInvoker _clpInvoker = new VanBanDiLocalServiceClpInvoker();
}