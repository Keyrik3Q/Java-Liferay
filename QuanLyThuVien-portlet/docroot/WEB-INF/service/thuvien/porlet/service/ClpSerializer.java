...
import thuvien.porlet.model.PhieuMuonClp;
import thuvien.porlet.model.SachClp;
import thuvien.porlet.model.TheLoaiClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"QuanLyThuVien-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "QuanLyThuVien-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("thuvien.porlet.model.impl.PhieuMuonImpl")) {
		...
		if (oldModelClassName.equals("thuvien.porlet.model.impl.SachImpl")) {
		...
		if (oldModelClassName.equals("thuvien.porlet.model.impl.TheLoaiImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("thuvien.porlet.NoSuchPhieuMuonException")) {
			return new thuvien.porlet.NoSuchPhieuMuonException();
		}

		if (className.equals("thuvien.porlet.NoSuchSachException")) {
			return new thuvien.porlet.NoSuchSachException();
		}

		if (className.equals("thuvien.porlet.NoSuchTheLoaiException")) {
			return new thuvien.porlet.NoSuchTheLoaiException();
		}
