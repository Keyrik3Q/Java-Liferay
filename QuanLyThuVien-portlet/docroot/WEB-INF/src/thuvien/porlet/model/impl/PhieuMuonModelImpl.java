...
import thuvien.porlet.model.PhieuMuonModel;
import thuvien.porlet.model.PhieuMuonSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link thuvien.porlet.model.PhieuMuonModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link PhieuMuonImpl}.
 * </p>
 *
 * @author HungThai
 * @see PhieuMuonImpl
 * @see thuvien.porlet.model.PhieuMuon
 * @see thuvien.porlet.model.PhieuMuonModel
 * @generated
 */
@JSON(strict = true)
public class PhieuMuonModelImpl extends BaseModelImpl<PhieuMuon>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a phieu muon model instance should use the {@link thuvien.porlet.model.PhieuMuon} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table phieumuon (id LONG not null primary key,userid VARCHAR(75) null,sachid LONG,ngaymuon DATE null,ngaytra DATE null,soluong LONG,xacnhan VARCHAR(75) null,trangthai VARCHAR(75) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.thuvien.porlet.model.PhieuMuon"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.thuvien.porlet.model.PhieuMuon"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.thuvien.porlet.model.PhieuMuon"));
